<?php
/**
 * Clean Database Migration Script: SQLite to MySQL
 * This script drops and recreates the target database to avoid tablespace issues
 */
...
$mysqlHost = '127.0.0.1';
$mysqlPort = '3306';
$mysqlDatabase = 'infinity_final_new';
$mysqlUsername = 'root';
$mysqlPassword = '';

echo "=== Clean Database Migration: SQLite to MySQL ===\n";
