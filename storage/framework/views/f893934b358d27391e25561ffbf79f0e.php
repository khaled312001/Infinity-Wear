...
<?php $__env->startSection('title', 'الفواتير - لوحة تحكم المستورد'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة المستورد'); ?>
<?php $__env->startSection('page-title', 'الفواتير'); ?>
<?php $__env->startSection('page-subtitle', 'إدارة ومتابعة فواتيرك'); ?>
            ...
            <div class="dashboard-card">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        ...
                        <div>
                            <h4 class="mb-0"><?php echo e($totalInvoices); ?></h4>
            ...
            <div class="dashboard-card">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        ...
                        <div>
                            <h4 class="mb-0"><?php echo e(number_format($paidAmount, 2)); ?></h4>
            ...
            <div class="dashboard-card">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        ...
                        <div>
                            <h4 class="mb-0"><?php echo e(number_format($pendingAmount, 2)); ?></h4>
                            ...
                            <table class="table table-hover" id="invoicesTable">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <strong>INV-<?php echo e(str_pad($invoice->id, 6, '0', STR_PAD_LEFT)); ?></strong>
                                            </td>
                                            <td>
                                                <a href="<?php echo e(route('importers.orders')); ?>" class="text-decoration-none">
                                                    #<?php echo e($invoice->order_number); ?>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <small class="text-muted"><?php echo e($invoice->created_at->format('H:i')); ?></small>
                                            </td>
                                            <td>
                                                <strong><?php echo e(number_format($invoice->final_cost ?? $invoice->estimated_cost ?? ($invoice->quantity * 50), 2)); ?> ريال</strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="<?php echo e($dueDate->isPast() && $invoice->status != 'paid' ? 'text-danger' : 'text-muted'); ?>">
                                                    <?php echo e($dueDate->format('Y-m-d')); ?>

                                                </span>
                                                <?php if($dueDate->isPast() && $invoice->status != 'paid'): ?>
                                                    <br><small class="text-danger">متأخرة</small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo e(route('importers.invoices.show', $invoice->id)); ?>" 
                                                       class="btn btn-sm btn-outline-primary" title="عرض الفاتورة">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-outline-success" 
                                                            onclick="downloadInvoice(<?php echo e($invoice->id); ?>)" title="تحميل PDF">
                                                        <i class="fas fa-download"></i>
                                                    </button>
                                                    <?php if($invoice->status != 'paid'): ?>
                                                        <button type="button" class="btn btn-sm btn-outline-warning" 
                                                                onclick="markAsPaid(<?php echo e($invoice->id); ?>)" title="تحديد كمدفوعة">
...
function filterInvoices() {
    ...
    window.location.href = '<?php echo e(route("importers.invoices")); ?>?' + params.toString();
}
...
function resetFilters() {
    ...
    window.location.href = '<?php echo e(route("importers.invoices")); ?>';
}
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\importers\invoices.blade.php ENDPATH**/ ?>