...
<?php $__env->startSection('title', 'إضافة عمل جديد'); ?>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.portfolio.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="completion_date" name="completion_date" value="<?php echo e(old('completion_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="ملابس رياضية" <?php echo e(old('category') == 'ملابس رياضية' ? 'selected' : ''); ?>>ملابس رياضية</option>
                                <option value="ملابس مدرسية" <?php echo e(old('category') == 'ملابس مدرسية' ? 'selected' : ''); ?>>ملابس مدرسية</option>
                                <option value="ملابس طبية" <?php echo e(old('category') == 'ملابس طبية' ? 'selected' : ''); ?>>ملابس طبية</option>
                                <option value="ملابس شركات" <?php echo e(old('category') == 'ملابس شركات' ? 'selected' : ''); ?>>ملابس شركات</option>
                                <option value="أزياء موحدة" <?php echo e(old('category') == 'أزياء موحدة' ? 'selected' : ''); ?>>أزياء موحدة</option>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\portfolio\create.blade.php ENDPATH**/ ?>