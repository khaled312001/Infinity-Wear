...
<head>
    ...
    <meta name="vapid-public-key" content="<?php echo e(config('push.vapid.public_key')); ?>">
...
<body>
            ...
            <div class="container">
                <div class="infinity-navbar-content">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('services')); ?>" class="nav-link<?php echo e(request()->routeIs('services') ? ' active' : ''); ?>">
                                <div class="nav-icon">
                        ...
                        <li>
                            <a href="<?php echo e(route('portfolio.index')); ?>" class="nav-link<?php echo e(request()->routeIs('portfolio.index') ? ' active' : ''); ?>">
                                <div class="nav-icon">
                        ...
                        <li>
                            <a href="<?php echo e(route('contact.index')); ?>" class="nav-link<?php echo e(request()->routeIs('contact.index') ? ' active' : ''); ?>">
                                <div class="nav-icon">
                    ...
                    <div class="header-actions">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route(Auth::user()->getDashboardRoute())); ?>" class="btn btn-outline">لوحة التحكم</a>ا
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('importers.form')); ?>" class="btn btn-primary">أطلب الآن</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <div class="mobile-sidebar" id="mobileSidebar">
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-actions">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route(Auth::user()->getDashboardRoute())); ?>" class="btn btn-sidebar-primary">لوحة التحكم</a>
                    <form method="POST" action="<?php echo e(route('logout')); ?>" class="d-inline">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('importers.form')); ?>" class="btn btn-sidebar-primary">أطلب الآن</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="footer-services-section">
                        ...
                        <ul class="footer-services-links">
                            ...
                            <li><a href="<?php echo e(route('importers.form')); ?>">أطلب الآن</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <link href="<?php echo e(asset('css/notifications.css')); ?>" rel="stylesheet">
    
    <!-- Pusher Beams Configuration -->
    <script src="<?php echo e(asset('js/pusher-beams.js')); ?>"></script>
</body>
