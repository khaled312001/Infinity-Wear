...
<?php $__env->startSection('title', 'الإشعارات - لوحة تحكم المستورد'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة المستورد'); ?>
<?php $__env->startSection('page-title', 'الإشعارات'); ?>
<?php $__env->startSection('page-subtitle', 'متابعة آخر التحديثات والتنبيهات'); ?>
            ...
            <div class="dashboard-card">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        ...
                        <div>
                            <h4 class="mb-0"><?php echo e($totalCount); ?></h4>
            ...
            <div class="dashboard-card">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        ...
                        <div>
                            <h4 class="mb-0"><?php echo e($totalCount - $unreadCount); ?></h4>
            ...
            <div class="dashboard-card">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        ...
                        <div>
                            <a href="<?php echo e(route('importers.notification-settings')); ?>" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item notification-item <?php echo e(!$notification['is_read'] ? 'unread' : ''); ?>" 
                                     ...
                                     data-status="<?php echo e($notification['is_read'] ? 'read' : 'unread'); ?>"
                                     data-date="<?php echo e($notification['created_at']->format('Y-m-d')); ?>">
                                    
                                    <div class="d-flex align-items-start">
                                        <div class="notification-icon me-3">
                                            <div class="icon-wrapper bg-<?php echo e($notification['color']); ?>">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start mb-1">
                                                <h6 class="notification-title mb-0 <?php echo e(!$notification['is_read'] ? 'fw-bold' : ''); ?>">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="notification-badges">
                                                    <span class="badge bg-<?php echo e($notification['color']); ?> me-1">
