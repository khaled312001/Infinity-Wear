...
<body>
    <div class="container">
        ...
        <div class="info">
            ...
            CSRF Token: <code><?php echo e(csrf_token()); ?></code><br>
            Session ID: <code><?php echo e(session()->getId()); ?></code>
        </div>

        <form method="POST" action="<?php echo e(route('login')); ?>" id="testForm">
            <?php echo csrf_field(); ?>
...
<?php /**PATH F:\infinity\Infinity-Wear\resources\views\auth\login-test.blade.php ENDPATH**/ ?>