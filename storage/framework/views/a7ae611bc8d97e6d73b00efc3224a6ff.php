...
<?php $__env->startSection('dashboard-title', 'إعدادات النظام'); ?>
<?php $__env->startSection('page-title', 'الإعدادات العامة'); ?>
<?php $__env->startSection('page-subtitle', 'إدارة إعدادات الموقع والنظام العامة'); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" id="settingsForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="site_name" 
                                               name="site_name" 
                                               value="<?php echo e(old('site_name', $settings['site_name'] ?? 'Infinity Wear')); ?>" 
                                               required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="site_tagline" 
                                               name="site_tagline" 
                                               value="<?php echo e(old('site_tagline', $settings['site_tagline'] ?? 'مؤسسة الزي اللامحدود')); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  rows="3" 
                                                  required><?php echo e(old('site_description', $settings['site_description'] ?? 'مؤسسة الزي اللامحدود - متخصصون في تصنيع وتوريد الملابس والزي الرسمي للشركات والمؤسسات')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="currentLogo" class="mt-3">
                                            ...
                                            <div class="mt-1">
                                                <img id="currentLogoImage" src="<?php echo e(\App\Helpers\SiteSettingsHelper::getLogoUrl()); ?>" 
                                                     alt="الشعار الحالي" 
                                                     class="img-thumbnail" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="currentFavicon" class="mt-3">
                                            ...
                                            <div class="mt-1">
                                                <img id="currentFaviconImage" src="<?php echo e(\App\Helpers\SiteSettingsHelper::getFaviconUrl()); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                               id="contact_email" 
                                               name="contact_email" 
                                               value="<?php echo e(old('contact_email', $settings['contact_email'] ?? 'info@infinitywear.com')); ?>" 
                                               required>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="contact_phone" 
                                               name="contact_phone" 
                                               value="<?php echo e(old('contact_phone', $settings['contact_phone'] ?? '+966500982394')); ?>" 
                                               required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" 
                                               ...
                                               value="<?php echo e(old('whatsapp_number', '+966500982394')); ?>">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" 
                                                  ...
                                                  rows="3"
                                                  placeholder="مرحباً، أريد الاستفسار عن خدماتكم..."><?php echo e(old('whatsapp_message', 'مرحباً، أريد الاستفسار عن خدماتكم في الملابس الرياضية والزي الموحد')); ?></textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" 
                                               ...
                                               id="support_email" 
                                               name="support_email" 
                                               value="<?php echo e(old('support_email', 'support@infinitywear.com')); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  name="address" 
                                                  rows="3" 
                                                  required><?php echo e(old('address', $settings['address'] ?? 'المملكة العربية السعودية، الرياض، حي النخيل، شارع الملك فهد')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="business_hours" 
                                               name="business_hours" 
                                               value="<?php echo e(old('business_hours', 'الأحد - الخميس: 8:00 ص - 6:00 م')); ?>">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" 
                                               ...
                                               value="<?php echo e(old('emergency_contact', '+966 50 987 6543')); ?>">
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="facebook_url" 
                                               name="facebook_url" 
                                               value="<?php echo e(old('facebook_url', 'https://facebook.com/infinitywear')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" 
                                               class="form-control <?php $__errorArgs = ['twitter_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               id="twitter_url" 
                                               name="twitter_url" 
                                               value="<?php echo e(old('twitter_url', 'https://twitter.com/infinitywear')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" 
                                               class="form-control <?php $__errorArgs = ['instagram_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               id="instagram_url" 
                                               name="instagram_url" 
                                               value="<?php echo e(old('instagram_url', 'https://instagram.com/infinitywear')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                               id="linkedin_url" 
                                               name="linkedin_url" 
                                               value="<?php echo e(old('linkedin_url', 'https://linkedin.com/company/infinitywear')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" 
                                               ...
                                               id="youtube_url" 
                                               name="youtube_url" 
                                               value="<?php echo e(old('youtube_url', 'https://youtube.com/c/infinitywear')); ?>"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" 
                                               ...
                                               id="tiktok_url" 
                                               name="tiktok_url" 
                                               value="<?php echo e(old('tiktok_url')); ?>"
                                        ...
                                        <div class="alert alert-info">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">
                                                        إصدار PHP: <?php echo e(PHP_VERSION); ?> | 
                                                        إصدار Laravel: <?php echo e(app()->version()); ?> | 
                                                        مساحة القرص المتاحة: <?php echo e(round(disk_free_space('/') / 1024 / 1024 / 1024, 2)); ?> GB
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function uploadLogo() {
            ...
            fetch('<?php echo e(route("admin.logo.upload")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function deleteLogo() {
            ...
            fetch('<?php echo e(route("admin.logo.delete")); ?>', {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json'
        ...
        function updateGeneralSettings() {
            ...
            fetch('<?php echo e(route("admin.settings.general")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function updateContactSettings() {
            ...
            fetch('<?php echo e(route("admin.settings.contact")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function updateSocialSettings() {
            ...
            fetch('<?php echo e(route("admin.settings.social")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function uploadFavicon() {
            ...
            fetch('<?php echo e(route("admin.favicon.upload")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function deleteFavicon() {
            ...
            fetch('<?php echo e(route("admin.favicon.delete")); ?>', {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\settings.blade.php ENDPATH**/ ?>