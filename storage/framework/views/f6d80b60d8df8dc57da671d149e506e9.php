...
<?php $__env->startSection('page-subtitle', 'إدارة الإيرادات والمصروفات'); ?>
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-3">
                    <a href="<?php echo e(route('admin.finance.create')); ?>" class="btn btn-primary btn-lg">
                        <i class="fas fa-plus me-2"></i>
                        معاملة جديدة
                    </a>
                    <a href="<?php echo e(route('admin.finance.reports')); ?>" class="btn btn-outline-primary btn-lg">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.finance.transactions')); ?>">
                                <i class="fas fa-list me-2"></i>جميع المعاملات
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.finance.export')); ?>">
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="finance-card" data-aos="fade-up" data-aos-duration="800">
                ...
                <h2 class="mb-2 fw-bold"><?php echo e(number_format($stats['monthly_revenue'], 2)); ?> ريال</h2>
                <p class="mb-2 fs-6">إيرادات هذا الشهر</p>
                <div class="d-flex align-items-center">
                    <i class="fas fa-calendar-alt me-2 opacity-75"></i>
                    <small class="opacity-75"><?php echo e(Carbon\Carbon::now()->format('F Y')); ?></small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="finance-card expense" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
                ...
                <h2 class="mb-2 fw-bold"><?php echo e(number_format($stats['monthly_expenses'], 2)); ?> ريال</h2>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="finance-card profit" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <div class="text-end">
                        <?php if($stats['monthly_profit'] > 0): ?>
                            <span class="badge bg-light text-success">
                                <i class="fas fa-arrow-up me-1"></i>
                                ربح
                            </span>
                        <?php elseif($stats['monthly_profit'] < 0): ?>
                            <span class="badge bg-light text-danger">
                ...
                <h2 class="mb-2 fw-bold"><?php echo e(number_format($stats['monthly_profit'], 2)); ?> ريال</h2>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="finance-card neutral" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
                ...
                <h2 class="mb-2 fw-bold"><?php echo e(number_format($stats['yearly_stats']['transactions_count'])); ?></h2>
        ...
        <div class="col-lg-4 mb-4">
            <div class="chart-container" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?php echo e(route('admin.finance.transactions')); ?>" class="btn btn-sm btn-outline-primary">
                ...
                <div class="transactions-list" style="max-height: 500px; overflow-y: auto;">
                    <?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="transaction-item <?php echo e($transaction->type); ?>" data-aos="fade-left" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="me-3">
                                            <div class="transaction-icon <?php echo e($transaction->type); ?>">
                                                <i class="fas fa-<?php echo e($transaction->type === 'income' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1 fw-semibold"><?php echo e(Str::limit($transaction->description, 35)); ?></h6>
                                ...
                                <div class="text-end">
                                    <div class="amount-badge <?php echo e($transaction->type); ?>">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-5 text-muted">
                            <div class="empty-state">
                                ...
                                <a href="<?php echo e(route('admin.finance.create')); ?>" class="btn btn-primary">
                                    <i class="fas fa-plus me-2"></i>
                                    إضافة معاملة
                                </a>
                            </div>
                    ...
                    <div class="category-progress">
                        ...
                        <div class="progress">
                            <div class="progress-bar bg-success" 
                                 style="width: <?php echo e($incomeCategories->max('total') > 0 ? round(($category->total / $incomeCategories->max('total')) * 100, 1) : 0); ?>%">
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="category-progress">
                        ...
                        <div class="progress">
                            <div class="progress-bar bg-danger" 
                                 style="width: <?php echo e($expenseCategories->max('total') > 0 ? round(($category->total / $expenseCategories->max('total')) * 100, 1) : 0); ?>%">
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="col-12">
            <div class="chart-container" data-aos="fade-up">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <span class="badge bg-warning"><?php echo e($pendingTransactions->count()); ?> معاملة</span>
                </div>
                    ...
                    <?php $__currentLoopData = $pendingTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 mb-3">
                            <div class="transaction-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1"><?php echo e(Str::limit($transaction->description, 30)); ?></h6>
                                        <small class="text-muted">
                                            <i class="fas fa-calendar-alt me-1"></i>
                                            <?php echo e($transaction->transaction_date->format('d/m/Y')); ?>
                                    ...
                                    <div class="text-end">
                                        <span class="badge bg-<?php echo e($transaction->type === 'income' ? 'success' : 'danger'); ?>">
                                            <?php echo e(number_format($transaction->amount, 2)); ?> ريال
                                        </span>
                                        <div class="mt-2">
                                            <a href="<?php echo e(route('admin.finance.show', $transaction)); ?>" class="btn btn-sm btn-outline-primary">
...
<div class="quick-actions">
    <button class="quick-action-btn" onclick="location.href='<?php echo e(route('admin.finance.create')); ?>'" title="معاملة جديدة">
        <i class="fas fa-plus"></i>
    </button>
    <button class="quick-action-btn" onclick="location.href='<?php echo e(route('admin.finance.reports')); ?>'" title="التقارير">
        <i class="fas fa-chart-pie"></i>
    </button>
    <button class="quick-action-btn" onclick="location.href='<?php echo e(route('admin.finance.transactions')); ?>'" title="جميع المعاملات">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\finance\dashboard.blade.php ENDPATH**/ ?>