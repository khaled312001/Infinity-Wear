<?php $__env->startSection('title', 'إضافة تقييم جديد - مؤسسة الزي اللامحدود'); ?>
            ...
            <div class="col-lg-8">
                <div class="enhanced-form-card" data-aos="fade-up">
                    ...
                    <div class="form-body">
                        ...
                        <form action="<?php echo e(route('testimonials.store')); ?>" method="POST" enctype="multipart/form-data" id="testimonialForm">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="client_name" name="client_name" value="<?php echo e(old('client_name')); ?>" required placeholder="أدخل اسمك الكامل">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="client_position" name="client_position" value="<?php echo e(old('client_position')); ?>" required placeholder="مثال: مدير التسويق">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="client_company" name="client_company" value="<?php echo e(old('client_company')); ?>" required placeholder="أدخل اسم الشركة أو المؤسسة">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="5" required placeholder="اكتب تجربتك مع منتجاتنا أو خدماتنا..."><?php echo e(old('content')); ?></textarea>
                                ...
                                <div class="rating-container">
                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                        <div class="rating-option">
                                            <input type="radio" name="rating" id="rating<?php echo e($i); ?>" value="<?php echo e($i); ?>" <?php echo e(old('rating', 5) == $i ? 'checked' : ''); ?>>
                                            <label for="rating<?php echo e($i); ?>">
                ...
                <div class="text-center mt-4">
                    <a href="<?php echo e(route('testimonials.index')); ?>" class="back-button">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\testimonials\create.blade.php ENDPATH**/ ?>