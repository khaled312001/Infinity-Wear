<?php $__env->startSection('title', 'تعديل بيانات المستورد'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة الإدارة'); ?>
<?php $__env->startSection('page-title', 'تعديل بيانات المستورد'); ?>
<?php $__env->startSection('page-subtitle', 'تعديل بيانات المستورد: ' . $importer->name); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.importers.update', $importer->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="phone" name="phone" value="<?php echo e(old('phone', $importer->phone)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="company_name" name="company_name" value="<?php echo e(old('company_name', $importer->company_name)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="business_type_other" name="business_type_other" value="<?php echo e(old('business_type_other', $importer->business_type_other)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="new" <?php echo e(old('status', $importer->status) == 'new' ? 'selected' : ''); ?>>جديد</option>
                                <option value="contacted" <?php echo e(old('status', $importer->status) == 'contacted' ? 'selected' : ''); ?>>تم التواصل</option>
                                <option value="qualified" <?php echo e(old('status', $importer->status) == 'qualified' ? 'selected' : ''); ?>>مؤهل</option>
                                <option value="proposal" <?php echo e(old('status', $importer->status) == 'proposal' ? 'selected' : ''); ?>>تم تقديم عرض</option>
                                <option value="negotiation" <?php echo e(old('status', $importer->status) == 'negotiation' ? 'selected' : ''); ?>>قيد التفاوض</option>
                                <option value="closed_won" <?php echo e(old('status', $importer->status) == 'closed_won' ? 'selected' : ''); ?>>تم إغلاق الصفقة بنجاح</option>
                                <option value="closed_lost" <?php echo e(old('status', $importer->status) == 'closed_lost' ? 'selected' : ''); ?>>تم إغلاق الصفقة بدون نجاح</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                              id="notes" name="notes" rows="3"><?php echo e(old('notes', $importer->notes)); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\importers\edit.blade.php ENDPATH**/ ?>