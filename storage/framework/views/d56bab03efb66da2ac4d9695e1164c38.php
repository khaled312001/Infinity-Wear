...
<?php $__env->startSection('title', 'إدارة المهام - المبيعات'); ?>
<?php $__env->startSection('dashboard-title', 'إدارة المهام'); ?>
<?php $__env->startSection('page-title', 'لوحة المهام'); ?>
<?php $__env->startSection('page-subtitle', 'نظام إدارة المهام لفريق المبيعات'); ?>
                            ...
                            <div class="task-column" data-column-id="<?php echo e($column->id); ?>" data-board-id="<?php echo e($board->id); ?>">
                                <div class="column-header">
                                    ...
                                    <div class="column-actions">
                                        <span class="badge bg-light text-dark">فريق المبيعات</span>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\sales\tasks\index.blade.php ENDPATH**/ ?>