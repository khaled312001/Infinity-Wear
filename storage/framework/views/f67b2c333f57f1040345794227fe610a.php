...
<?php $__env->startSection('title', 'إضافة مشروع جديد - فريق التسويق'); ?>
<?php $__env->startSection('dashboard-title', 'إضافة مشروع جديد'); ?>
<?php $__env->startSection('page-title', 'إضافة مشروع جديد'); ?>
<?php $__env->startSection('page-subtitle', 'إضافة مشروع جديد إلى معرض الأعمال'); ?>
...
<div class="row">
    <div class="col-12">
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('marketing.portfolio.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="football" <?php echo e(old('category') == 'football' ? 'selected' : ''); ?>>كرة قدم</option>
                                <option value="basketball" <?php echo e(old('category') == 'basketball' ? 'selected' : ''); ?>>كرة سلة</option>
                                <option value="school" <?php echo e(old('category') == 'school' ? 'selected' : ''); ?>>مدرسة</option>
                                <option value="company" <?php echo e(old('category') == 'company' ? 'selected' : ''); ?>>شركة</option>
...
<?php echo $__env->make('layouts.marketing-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\marketing\portfolio\create.blade.php ENDPATH**/ ?>