...
<head>
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo e(asset('images/logo.png')); ?>">
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo e(asset('images/logo.png')); ?>">
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo e(asset('images/logo.png')); ?>">
    ...
    <style>
        ...
        .stats-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--sales-color), var(--primary-color));
        }
        ...
        .stats-icon.primary { background: linear-gradient(135deg, var(--sales-color), var(--primary-color)); }
        ...
        .brand-logo {
            font-size: 1.5rem;
            font-weight: 800;
            background: linear-gradient(135deg, #059669, #ffffff);
        ...
        .btn-primary {
            background: linear-gradient(135deg, var(--sales-color), var(--primary-color));
            border: none;
            border-radius: 10px;
            padding: 10px 20px;
            font-weight: 500;
...
<body class="sales-authenticated">
    <!-- Top Navigation -->
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top shadow-sm">
        <div class="container-fluid">
            <!-- Brand Section -->
            <div class="d-flex align-items-center">
                <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('sales.dashboard')); ?>">
                    <div class="brand-icon me-3">
                        <i class="fas fa-handshake text-primary"></i>
                    </div>
                    <div class="brand-text">
                        <strong class="brand-name">Infinity Wear</strong>
                        <small class="brand-subtitle d-block">لوحة تحكم المبيعات</small>
                    </div>
                </a>
            </div>
            ...
            <div class="d-flex align-items-center flex-grow-1 justify-content-center mx-4">
                ...
                <div class="quick-actions d-none d-lg-flex">
                    <a href="<?php echo e(route('sales.importer-orders')); ?>" class="btn btn-outline-primary btn-sm me-2" title="عرض طلبات المستوردين الجديدة">
                        <i class="fas fa-industry me-1"></i>
                        طلبات المستوردين
                    </a>
                    <a href="<?php echo e(route('sales.importers')); ?>" class="btn btn-outline-success btn-sm me-2" title="عرض المستوردين الجدد">
                        <i class="fas fa-users me-1"></i>
                        مستوردين جدد
                    </a>
                    <a href="<?php echo e(route('sales.contacts')); ?>" class="btn btn-outline-info btn-sm me-2" title="عرض جهات الاتصال الجديدة">
                ...
                <div class="dropdown">
                    <button class="btn btn-outline-primary dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                        ...
                        <div class="user-info d-none d-md-block">
                            ...
                            <small class="user-role text-muted">فريق المبيعات</small>
                        </div>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('sales.profile')); ?>"><i class="fas fa-user me-2"></i>الملف الشخصي</a></li>
                ...
                <div class="main-content">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="page-subtitle"><?php echo $__env->yieldContent('page-subtitle', 'مرحبا بك في لوحة تحكم المبيعات'); ?></p>
                        </div>
                        <div>
...
<?php /**PATH F:\infinity\Infinity-Wear\resources\views\layouts\sales-dashboard.blade.php ENDPATH**/ ?>