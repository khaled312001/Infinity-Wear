    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top shadow-sm">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('marketing.dashboard')); ?>">
            ...
            <div class="d-flex align-items-center flex-grow-1 justify-content-center mx-4">
                ...
                <div class="quick-actions d-none d-lg-flex">
                    <a href="<?php echo e(route('marketing.portfolio.create')); ?>" class="btn btn-outline-primary btn-sm me-2" title="إضافة مشروع جديد">
                        <i class="fas fa-plus me-1"></i>
                        مشروع جديد
                    </a>
                    <a href="<?php echo e(route('marketing.testimonials.create')); ?>" class="btn btn-outline-success btn-sm me-2" title="إضافة تقييم جديد">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('marketing.profile')); ?>"><i class="fas fa-user me-2"></i>الملف الشخصي</a></li>
                ...
                <div class="main-content">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="page-subtitle"><?php echo $__env->yieldContent('page-subtitle', 'مرحبا بك في لوحة تحكم التسويق'); ?></p>
                        </div>
                        <div>
...
<?php /**PATH F:\infinity\Infinity-Wear\resources\views\layouts\marketing-dashboard.blade.php ENDPATH**/ ?>