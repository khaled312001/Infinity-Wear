...
<?php $__env->startSection('title', 'إنفينيتي وير - ملابس رياضية احترافية'); ?>
<?php $__env->startSection('description', 'إنفينيتي وير - شركة سعودية رائدة في تصميم وإنتاج الملابس الرياضية والزي الموحد للفرق والمدارس والشركات'); ?>

<?php $__env->startSection('styles'); ?>
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('css/infinity-home.css')); ?>" rel="stylesheet">
    <!-- Home Page Responsive CSS -->
    <link href="<?php echo e(asset('css/home-responsive.css')); ?>" rel="stylesheet">
    ...
    <section id="portfolio" class="infinity-portfolio">
        <div class="container">
            ...
            <div class="infinity-portfolio-grid">
                <?php $__empty_1 = true; $__currentLoopData = $featuredPortfolio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="portfolio-item" data-category="<?php echo e($item->category); ?>">
                    <div class="portfolio-image">
                        <?php if($item->image): ?>
                            <img src="<?php echo e(Storage::url($item->image)); ?>" alt="<?php echo e($item->title); ?>" 
                                 class="portfolio-dynamic-image">
                        <?php else: ?>
                            <img src="<?php echo e(asset('images/default-image.png')); ?>" alt="<?php echo e($item->title); ?>">
                        <?php endif; ?>
                        <div class="portfolio-overlay">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-meta">
                                    <small class="text-muted"><?php echo e($item->client_name ?? 'غير محدد'); ?></small>
                                    <span class="badge bg-primary"><?php echo e($item->category); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="testimonials-slider">
                        ...
                        <div class="testimonial-content">
                            ...
                            <div class="testimonial-author">
                                <div class="author-avatar">
                                    <img src="<?php echo e(asset('images/avatar-1.svg')); ?>" alt="أحمد محمد">
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-content">
                            ...
                            <div class="testimonial-author">
                                <div class="author-avatar">
                                    <img src="<?php echo e(asset('images/avatar-2.svg')); ?>" alt="سارة أحمد">
                                    <div class="avatar-ring"></div>
                                </div>
                                <div class="author-info">
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-content">
                            ...
                            <div class="testimonial-author">
                                <div class="author-avatar">
                                    <img src="<?php echo e(asset('images/avatar-3.svg')); ?>" alt="محمد علي">
                                    <div class="avatar-ring"></div>
                                </div>
                                <div class="author-info">
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-content">
                            ...
                            <div class="testimonial-author">
                                <div class="author-avatar">
                                    <img src="<?php echo e(asset('images/avatar-1.svg')); ?>" alt="فاطمة السعد">
                                    <div class="avatar-ring"></div>
                                </div>
                                <div class="author-info">
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-content">
                            ...
                            <div class="testimonial-author">
                                <div class="author-avatar">
                                    <img src="<?php echo e(asset('images/avatar-2.svg')); ?>" alt="خالد الرشيد">
                                    <div class="avatar-ring"></div>
                                </div>
                                <div class="author-info">
                ...
                <div class="infinity-contact-info" style="width: 100%; margin-bottom: 2rem;">
                    <div class="infinity-contact-card">
                        ...
                        <div class="infinity-contact-details">
                            <h3>عنواننا</h3>
                            <p><?php echo e(\App\Models\Setting::get('address', 'الرياض، حي النخيل، المملكة العربية السعودية')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="infinity-contact-card">
                        ...
                        <div class="infinity-contact-details">
                            <h3>ساعات العمل</h3>
                            <p><?php echo e(\App\Models\Setting::get('business_hours', 'الأحد - الخميس: 8:00 ص - 6:00 م')); ?></p>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    <!-- Custom JavaScript -->
    <script src="<?php echo e(asset('js/infinity-home.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <!-- Home Page Responsive JavaScript -->
    <script src="<?php echo e(asset('js/home-responsive.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views/home.blade.php ENDPATH**/ ?>