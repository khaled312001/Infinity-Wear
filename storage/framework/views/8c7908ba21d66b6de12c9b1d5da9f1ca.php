...
<?php $__env->startSection('title', 'إضافة معاملة مالية'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة الإدارة'); ?>
<?php $__env->startSection('page-title', 'إضافة معاملة مالية'); ?>
<?php $__env->startSection('page-subtitle', 'إضافة إيراد أو مصروف جديد'); ?>
            ...
            <div class="dashboard-card">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('admin.finance.index')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.finance.store')); ?>" method="POST" id="transactionForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <optgroup label="الإيرادات" id="income-categories" style="display: none;">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" 
                                      placeholder="وصف تفصيلي للمعاملة" required></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text">يمكن رفع عدة ملفات (PDF, صور, مستندات)</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="3" 
                                      placeholder="أي ملاحظات إضافية حول المعاملة"></textarea>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\finance\create.blade.php ENDPATH**/ ?>