...
<head>
    ...
    <title>الموقع تحت الصيانة - <?php echo e(\App\Helpers\SettingsHelper::get('site_name', 'Infinity Wear')); ?></title>
...
<body>
    <div class="maintenance-container">
        ...
        <div class="contact-info">
            ...
            <?php if($contactInfo['whatsapp']): ?>
                <div class="contact-item">
                    <i class="fab fa-whatsapp"></i>
                    <span><?php echo e($contactInfo['whatsapp']); ?></span>
                </div>
            <?php endif; ?>
            ...
            <?php if($contactInfo['email']): ?>
                <div class="contact-item">
                    ...
                    <span><?php echo e($contactInfo['email']); ?></span>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-4">
            <small class="text-muted">
                ...
                آخر تحديث: <?php echo e(now()->format('Y-m-d H:i')); ?>
...
<?php /**PATH F:\infinity\Infinity-Wear\resources\views\maintenance.blade.php ENDPATH**/ ?>