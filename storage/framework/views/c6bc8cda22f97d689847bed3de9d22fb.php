<?php $__env->startSection('title', 'إضافة مستورد جديد'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة الإدارة'); ?>
<?php $__env->startSection('page-title', 'إضافة مستورد جديد'); ?>
<?php $__env->startSection('page-subtitle', 'إضافة مستورد جديد للنظام'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.importers.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="academy" <?php echo e(old('business_type') == 'academy' ? 'selected' : ''); ?>>أكاديمية</option>
                                <option value="school" <?php echo e(old('business_type') == 'school' ? 'selected' : ''); ?>>مدرسة</option>
                                <option value="store" <?php echo e(old('business_type') == 'store' ? 'selected' : ''); ?>>متجر</option>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="business_type_other" name="business_type_other" value="<?php echo e(old('business_type_other')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between">
                    <a href="<?php echo e(route('admin.importers.index')); ?>" class="btn btn-secondary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\importers\create.blade.php ENDPATH**/ ?>