...
<?php $__env->startSection('title', 'التواصل معنا - لوحة تحكم المستورد'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة المستورد'); ?>
<?php $__env->startSection('page-title', 'التواصل معنا'); ?>
<?php $__env->startSection('page-subtitle', 'تواصل معنا مباشرة لأي استفسار أو مساعدة'); ?>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="dashboard-card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-2"><?php echo e($contactInfo['phone']); ?></p>
                    <a href="tel:<?php echo e($contactInfo['phone']); ?>" class="btn btn-outline-primary btn-sm">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="dashboard-card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-2"><?php echo e($contactInfo['email']); ?></p>
                    <a href="mailto:<?php echo e($contactInfo['email']); ?>" class="btn btn-outline-success btn-sm">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="dashboard-card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-2"><?php echo e($contactInfo['whatsapp']); ?></p>
                    <a href="https://wa.me/<?php echo e(str_replace(['+', ' '], '', $contactInfo['whatsapp'])); ?>" 
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="dashboard-card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-2"><?php echo e($contactInfo['address']); ?></p>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('importers.contact.send')); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <div class="dashboard-card mb-4">
                ...
                <div class="card-body">
                    <div class="working-hours">
                        ...
                        <p class="text-muted mb-3"><?php echo e($contactInfo['working_hours']); ?></p>
                ...
                <div class="card-body">
                    <div class="emergency-contact">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="tel:<?php echo e($contactInfo['emergency_contact']); ?>" class="text-decoration-none">
                                <?php echo e($contactInfo['emergency_contact']); ?>
                ...
                <div class="card-body">
                    <div id="map" style="height: 400px; border-radius: 8px; background: #f8f9fa; display: flex; align-items: center; justify-content: center;">
                        <div class="text-center">
                            ...
                            <p class="text-muted"><?php echo e($contactInfo['address']); ?></p>
...
function openGoogleMaps() {
    const address = encodeURIComponent('<?php echo e($contactInfo["address"]); ?>');
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\importers\contact.blade.php ENDPATH**/ ?>