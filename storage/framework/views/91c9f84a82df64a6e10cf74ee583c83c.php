...
<?php $__env->startSection('title', 'لوحة التحكم - الموظف'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة التحكم'); ?>
<?php $__env->startSection('page-title', 'لوحة التحكم'); ?>
<?php $__env->startSection('page-subtitle', 'مرحباً بك في لوحة تحكم الموظف'); ?>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="stats-card">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h3 class="mb-0"><?php echo e($taskStats['pending']); ?></h3>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="stats-card">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h3 class="mb-0"><?php echo e($taskStats['in_progress']); ?></h3>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="text-center">
                            <h3 class="text-primary"><?php echo e($monthlyPerformance['tasks_completed']); ?></h3>
                            <p class="text-muted mb-0">مهام مكتملة</p>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-center">
                            <h3 class="text-success"><?php echo e($monthlyPerformance['hours_worked']); ?></h3>
        ...
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h6 class="mb-1"><?php echo e($employee->employee_id); ?></h6>
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h6 class="mb-1"><?php echo e($employee->department_label); ?></h6>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-1"><?php echo e($employee->position); ?></h6>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <a href="<?php echo e(route('employee.tasks')); ?>" class="btn btn-primary w-100">
                            <i class="fas fa-tasks me-2"></i>
                            عرض جميع المهام
                        </a>
                    </div>
                    <div class="col-md-3 mb-3">
                        <a href="<?php echo e(route('employee.profile')); ?>" class="btn btn-info w-100">
                            <i class="fas fa-user me-2"></i>
                            الملف الشخصي
                        </a>
                    </div>
                    <?php if(Auth::user()->hasPermission('orders.view')): ?>
                    <div class="col-md-3 mb-3">
                    ...
                    <?php endif; ?>
                    <?php if(Auth::user()->hasPermission('transactions.view')): ?>
                    <div class="col-md-3 mb-3">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\employee\dashboard.blade.php ENDPATH**/ ?>