...
<?php $__env->startSection('title', 'تعديل المحتوى'); ?>
<?php $__env->startSection('dashboard-title', 'إدارة المحتوى'); ?>
<?php $__env->startSection('page-title', 'تعديل المحتوى'); ?>
<?php $__env->startSection('page-subtitle', 'تعديل المحتوى الموجود'); ?>
...
<div class="row">
    <div class="col-12">
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.content-management.update', $contentManagement)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="page_name" name="page_name" required>
                                            ...
                                            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e((old('page_name', $contentManagement->page_name) == $key) ? 'selected' : ''); ?>><?php echo e($value); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="section_name" name="section_name" required>
                                            ...
                                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e((old('section_name', $contentManagement->section_name) == $key) ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" id="content_type" name="content_type" required>
                                            ...
                                            <?php $__currentLoopData = $contentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e((old('content_type', $contentManagement->content_type) == $key) ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', $contentManagement->sort_order)); ?>" min="0">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $contentManagement->is_active) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" <?php echo e(old('is_featured', $contentManagement->is_featured) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="title_ar" name="title_ar" value="<?php echo e(old('title_ar', $contentManagement->title_ar)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                               id="title_en" name="title_en" value="<?php echo e(old('title_en', $contentManagement->title_en)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                                  id="description_ar" name="description_ar" rows="3"><?php echo e(old('description_ar', $contentManagement->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                                  id="description_en" name="description_en" rows="3"><?php echo e(old('description_en', $contentManagement->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                                  id="content_ar" name="content_ar" rows="4"><?php echo e(old('content_ar', $contentManagement->content_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                                  id="content_en" name="content_en" rows="4"><?php echo e(old('content_en', $contentManagement->content_en)); ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card border-0 shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <!-- الصورة الحالية -->
                                    <?php if($contentManagement->image_path): ?>
                                        <div class="mb-3">
                                            <label class="form-label">الصورة الحالية</label>
                                            <div>
                                                <img src="<?php echo e(asset('storage/' . $contentManagement->image_path)); ?>" 
                                                     alt="<?php echo e($contentManagement->title_ar ?: $contentManagement->title_en); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                       id="video_url" name="video_url" value="<?php echo e(old('video_url', $contentManagement->video_url)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <!-- معرض الصور الحالي -->
                                    <?php if($contentManagement->gallery_images && count($contentManagement->gallery_images) > 0): ?>
                                        <div class="mb-3">
                                            <label class="form-label">معرض الصور الحالي</label>
                                            <div class="row">
                                                <?php $__currentLoopData = $contentManagement->gallery_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                       id="button_text_ar" name="button_text_ar" value="<?php echo e(old('button_text_ar', $contentManagement->button_text_ar)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                                       id="button_text_en" name="button_text_en" value="<?php echo e(old('button_text_en', $contentManagement->button_text_en)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                                       id="button_url" name="button_url" value="<?php echo e(old('button_url', $contentManagement->button_url)); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\content-management\edit.blade.php ENDPATH**/ ?>