<?php $__env->startSection('title', 'الواتساب'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة الإدارة'); ?>
<?php $__env->startSection('page-title', 'الواتساب'); ?>
<?php $__env->startSection('page-subtitle', 'التواصل مع المستوردين وفريق التسويق والمبيعات'); ?>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-0"><?php echo e($stats['total_messages']); ?></h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-0"><?php echo e($stats['inbound_messages']); ?></h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-0"><?php echo e($stats['outbound_messages']); ?></h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-0"><?php echo e($stats['unread_messages']); ?></h3>
            ...
            <div class="dashboard-card">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group">
                            <a href="<?php echo e(route('admin.whatsapp.test')); ?>" class="btn btn-sm btn-success">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="conversations-list" style="max-height: 500px; overflow-y: auto;">
                        <?php if($messages->count() > 0): ?>
                            ...
                            <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phoneNumber => $conversationMessages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="conversation-item p-3 border-bottom" data-phone="<?php echo e($phoneNumber); ?>" style="cursor: pointer;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    <h6 class="mb-1"><?php echo e($contact['name'] ?? 'جهة اتصال غير معروفة'); ?></h6>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <?php endif; ?>
                                                    <button class="btn btn-sm btn-outline-success" onclick="openWhatsAppDirect('<?php echo e($phoneNumber); ?>')" title="فتح WhatsApp">
                                                        <i class="fab fa-whatsapp"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <p class="mb-0 text-muted small">
                                                <?php echo e(Str::limit($lastMessage->message_content, 50)); ?>

                                            </p>
                                            <small class="text-muted">
                                                <?php echo e($lastMessage->sent_at->diffForHumans()); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="contact_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($contact['id']); ?>" data-phone="<?php echo e($contact['phone']); ?>" data-type="<?php echo e($contact['type']); ?>">
                                        <?php echo e($contact['name']); ?> (<?php echo e($contact['phone']); ?>) - <?php echo e($contact['type_label']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views/admin/whatsapp/index.blade.php ENDPATH**/ ?>