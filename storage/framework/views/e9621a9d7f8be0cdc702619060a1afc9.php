            ...
            <div class="contact-info-section">
                ...
                <div class="contact-image-container">
                    <div class="contact-image-header">
                        ...
                        <p class="contact-image-subtitle"><?php echo e(\App\Models\Setting::get('address', 'مكة المكرمة  - شارع الستين ')); ?></p>
                    </div>
                    <div class="contact-image-wrapper">
                        <img src="<?php echo e(asset('images/hero/contact-hero.svg')); ?>" alt="تواصل معنا - Infinity Wear" class="contact-us-image">
                        <div class="contact-image-overlay">
                            <div class="contact-image-info">
                                ...
                                <a href="https://wa.me/<?php echo e(str_replace(['+', ' ', '-'], '', \App\Models\Setting::get('whatsapp_number'))); ?>" target="_blank" class="contact-btn contact-btn-primary">
