...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php if($portfolioItem->image): ?>
                                <div class="mt-2">
                                    ...
                                    <img src="<?php echo e(Storage::url($portfolioItem->image)); ?>" alt="Current image" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($portfolioItem->gallery && count($portfolioItem->gallery) > 0): ?>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <?php $__currentLoopData = $portfolioItem->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $galleryImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-6 mb-2">
                                            <div class="position-relative">
                                                <img src="<?php echo e(Storage::url($galleryImage)); ?>" alt="Gallery image" 
