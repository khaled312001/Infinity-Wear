...
<?php $__env->startSection('title', 'إنشاء حملة تسويقية'); ?>
<?php $__env->startSection('dashboard-title', 'لوحة الإدارة'); ?>
<?php $__env->startSection('page-title', 'إنشاء حملة تسويقية'); ?>
<?php $__env->startSection('page-subtitle', 'إرسال رسالة تسويقية للعملاء والفرق'); ?>
...
<?php $__env->startSection('page-actions'); ?>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.email-marketing.index')); ?>" class="btn btn-outline-secondary">
...
<form action="<?php echo e(route('admin.email-marketing.store')); ?>" method="POST" id="emailMarketingForm">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\email-marketing\create.blade.php ENDPATH**/ ?>