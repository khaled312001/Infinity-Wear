...
<?php $__env->startSection('title', 'تعديل تقرير المندوب التسويقي'); ?>
<?php $__env->startSection('dashboard-title', 'تعديل تقرير المندوب التسويقي'); ?>
<?php $__env->startSection('page-title', 'تعديل تقرير المندوب التسويقي'); ?>
<?php $__env->startSection('page-subtitle', 'تعديل تقرير المندوب التسويقي'); ?>
        ...
        <div class="dashboard-card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    ...
                    تعديل تقرير المندوب التسويقي
                </h5>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('sales.marketing-reports.update', $marketingReport)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="عمرو الدسوقي" <?php echo e(old('representative_name', $marketingReport->representative_name) == 'عمرو الدسوقي' ? 'selected' : ''); ?>>عمرو الدسوقي</option>
                                <option value="محمد علي" <?php echo e(old('representative_name', $marketingReport->representative_name) == 'محمد علي' ? 'selected' : ''); ?>>محمد علي</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('company_name', $marketingReport->company_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="3" required><?php echo e(old('company_address', $marketingReport->company_address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('responsible_name', $marketingReport->responsible_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('responsible_phone', $marketingReport->responsible_phone)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('responsible_position', $marketingReport->responsible_position)); ?>" required>
                        ...
                        <div class="col-12 mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="الخامة" 
                                               <?php echo e(in_array('الخامة', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="الجودة" 
                                               <?php echo e(in_array('الجودة', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="وقت التسليم" 
                                               <?php echo e(in_array('وقت التسليم', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="السعر" 
                                               <?php echo e(in_array('السعر', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : ''); ?>>
                            ...
                            <div class="mt-2">
                                <input type="text" name="customer_concerns[]" class="form-control" placeholder="أخرى:" 
                                       value="<?php echo e(old('customer_concerns.4', $marketingReport->customer_concerns[4] ?? '')); ?>">
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('target_quantity', $marketingReport->target_quantity)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('annual_consumption', $marketingReport->annual_consumption)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4"><?php echo e(old('recommendations', $marketingReport->recommendations)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4"><?php echo e(old('next_steps', $marketingReport->next_steps)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="3"><?php echo e(old('notes', $marketingReport->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="<?php echo e(route('sales.marketing-reports.show', $marketingReport)); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.sales-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\sales\marketing-reports\edit.blade.php ENDPATH**/ ?>