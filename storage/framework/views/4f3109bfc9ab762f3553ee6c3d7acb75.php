...
<?php $__env->startSection('title', 'إشعارات الموبايل'); ?>
<?php $__env->startSection('page-title', 'إشعارات الموبايل'); ?>
<?php $__env->startSection('page-subtitle', 'إدارة الإشعارات الفورية للموبايل'); ?>
            ...
            <div class="card stats-card enhanced">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="stats-number" id="total-subscriptions"><?php echo e($stats['total_subscriptions']); ?></h3>
            ...
            <div class="card stats-card enhanced">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="stats-number" id="active-subscriptions"><?php echo e($stats['active_subscriptions']); ?></h3>
            ...
            <div class="card stats-card enhanced">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="stats-number" id="mobile-subscriptions"><?php echo e($stats['mobile_subscriptions']); ?></h3>
            ...
            <div class="card stats-card enhanced">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="stats-number" id="desktop-subscriptions"><?php echo e($stats['desktop_subscriptions']); ?></h3>
                                    ...
                                    <tr>
                                        <td>
                                            <?php if($subscription->user): ?>
                                                <?php echo e($subscription->user->name ?? 'غير محدد'); ?>
                                        ...
                                        <td>
                                            <span class="badge bg-<?php echo e($subscription->user_type == 'admin' ? 'primary' : ($subscription->user_type == 'customer' ? 'success' : 'warning')); ?>">
                                                <?php echo e($subscription->user_type == 'admin' ? 'مدير' : ($subscription->user_type == 'customer' ? 'عميل' : 'مستورد')); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge bg-<?php echo e($subscription->device_type == 'mobile' ? 'info' : ($subscription->device_type == 'tablet' ? 'warning' : 'secondary')); ?>">
                                                <?php echo e($subscription->device_type == 'mobile' ? 'موبايل' : ($subscription->device_type == 'tablet' ? 'تابلت' : 'سطح المكتب')); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge bg-<?php echo e($subscription->is_active ? 'success' : 'danger'); ?>">
                                                <?php echo e($subscription->is_active ? 'نشط' : 'غير نشط'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if($subscription->last_used_at): ?>
                                                <?php echo e($subscription->last_used_at->diffForHumans()); ?>
                                        ...
                                        <td>
                                            <span class="badge bg-primary"><?php echo e($subscription->notification_count); ?></span>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <button class="btn btn-outline-<?php echo e($subscription->is_active ? 'warning' : 'success'); ?>" 
                                                        onclick="toggleSubscription(<?php echo e($subscription->id); ?>)">
                                                    <i class="fas fa-<?php echo e($subscription->is_active ? 'pause' : 'play'); ?>"></i>
                                                </button>
                                                <button class="btn btn-outline-danger" 
                                                        onclick="deleteSubscription(<?php echo e($subscription->id); ?>)">
...
$(document).ready(function() {
    ...
    $('#cleanup-subscriptions').click(function() {
        if (confirm('هل تريد تنظيف الاشتراكات القديمة؟')) {
            $.ajax({
                url: '<?php echo e(route("admin.notifications.push-notifications.cleanup")); ?>',
                method: 'POST',
                data: {
    ...
    $('#send-notification-form').submit(function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.notifications.push-notifications.send")); ?>',
            method: 'POST',
            data: formData,
            success: function(response) {
                if (response.success) {
...
function refreshStats() {
    $.ajax({
        url: '<?php echo e(route("admin.notifications.push-notifications.stats")); ?>',
        method: 'GET',
        success: function(response) {
            if (response.success) {
