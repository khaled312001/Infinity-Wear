...
<?php $__env->startSection('page-title', 'إدارة تقارير المندوبين التسويقيين'); ?>
<?php $__env->startSection('page-subtitle', 'مراجعة وإدارة تقارير المندوبين التسويقيين'); ?>
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <?php $__empty_1 = true; $__currentLoopData = $representativeStats->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="mb-3">
...
<?php if($reportsNeedingReview->count() > 0): ?>
<div class="row">
    <div class="col-12">
        <div class="dashboard-card">
            <div class="card-header">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $reportsNeedingReview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.marketing-reports.edit', $report)); ?>" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('admin.marketing-reports.analytics')); ?>" class="btn btn-outline-info">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="<?php echo e(route('admin.marketing-reports.destroy', $report)); ?>" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا التقرير؟')">
                                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="exportModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.marketing-reports.export')); ?>" method="GET">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\marketing-reports\index.blade.php ENDPATH**/ ?>