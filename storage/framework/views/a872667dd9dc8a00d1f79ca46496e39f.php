...
<?php $__env->startSection('content'); ?>
    <!-- Hero Section -->
    <section class="infinity-hero about-hero">
        <div class="infinity-hero-background"></div>
        <div class="container">
            <div class="infinity-hero-content">
                <div class="infinity-hero-text">
                    <h1 class="infinity-hero-title">من نحن</h1>
                    <p class="infinity-hero-subtitle">مؤسسة سعودية متخصصة في توريد الملابس الرياضية والزي الموحد</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-body p-5">
                        <h2 class="section-title text-center mb-4">Infinity Wear</h2>
                        ...
                        <div class="row g-4 mb-5">
                            <div class="col-md-6">
                                <div class="text-center">
                                    ...
                                    <h5>رؤيتنا</h5>
                                    <p>أن نكون الخيار الأول في توريد الملابس الرياضية والزي الموحد في المملكة العربية السعودية، ونساهم في تحقيق رؤية 2030</p>
                                </div>
                            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <h6>ثقة</h6>
                                    <p>نحن نثق في جودة منتجاتنا ونضمن رضا عملائنا الكرام</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <h6>سرعة</h6>
                                    <p>نوفر خدمات سريعة وفعالة لتلبية احتياجات عملائنا في الوقت المحدد</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <h6>مصداقية</h6>
                                    <p>نلتزم بالشفافية والمصداقية في جميع تعاملاتنا مع العملاء</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <h6>جودة</h6>
                                    <p>نستخدم أفضل المواد والتقنيات في تصنيع منتجاتنا</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <h6>تصميم</h6>
                                    <p>نقدم تصاميم عصرية ومبتكرة تناسب جميع الأذواق والاحتياجات</p>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="row text-center mb-5">
            <div class="col-12">
                ...
                <p class="lead">نقدم مجموعة شاملة من الخدمات المتخصصة</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row text-center mb-5">
            <div class="col-12">
                ...
                <div style="height: 200px; background-image: url('<?php echo e(asset('images/sections/team-collaboration.svg')); ?>'); background-size: contain; background-position: center; background-repeat: no-repeat; margin: 2rem 0;"></div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">فريق التصميم</h5>
                        <p class="card-text">مصممون محترفون يبتكرون أفضل التصاميم</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">فريق الإنتاج</h5>
                        <p class="card-text">خبراء في التصنيع والجودة</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">فريق دعم متاح لخدمتكم على مدار الساعة</p>
                    </div>
                </div>
            </div>
        </div>
