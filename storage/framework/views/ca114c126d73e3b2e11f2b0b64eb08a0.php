...
<?php $__env->startSection('title', 'تسجيل الدخول - Infinity Wear'); ?>
<?php $__env->startSection('description', 'سجل دخولك إلى حسابك في إنفينيتي وير للوصول إلى جميع الخدمات والمميزات'); ?>
    ...
    <div class="customer-login-container">
        <div class="login-card">
            ...
            <div class="login-form">
                ...
                <form method="POST" action="<?php echo e(route('sales.login.post')); ?>" id="loginForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\auth\login.blade.php ENDPATH**/ ?>