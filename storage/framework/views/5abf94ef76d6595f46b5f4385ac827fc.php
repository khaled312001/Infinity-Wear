...
<?php $__env->startSection('page-subtitle', 'إدارة إعدادات حسابك وتفضيلاتك'); ?>
...
<?php $__env->startSection('sidebar-menu'); ?>
    ...
    <a href="<?php echo e(route('customer.settings')); ?>" class="nav-link active">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('customer.settings.notifications')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-6">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('customer.settings.privacy')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="<?php echo e(route('customer.account.delete')); ?>" id="deleteAccountForm">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\customer\settings.blade.php ENDPATH**/ ?>