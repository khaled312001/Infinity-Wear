...
<?php $__env->startSection('title', 'جهات الاتصال المشتركة - فريق التسويق'); ?>
<?php $__env->startSection('dashboard-title', 'جهات الاتصال المشتركة'); ?>
<?php $__env->startSection('page-title', 'جهات الاتصال المشتركة'); ?>
<?php $__env->startSection('page-subtitle', 'إدارة جهات الاتصال المشتركة مع الإدارة والمبيعات'); ?>
...
<div class="row mb-4">
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="stats-card enhanced">
            <div class="stats-content text-center">
                <h3 class="stats-number text-primary"><?php echo e($stats['total']); ?></h3>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="stats-card enhanced">
            <div class="stats-content text-center">
                <h3 class="stats-number text-warning"><?php echo e($stats['new']); ?></h3>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="stats-card enhanced">
            <div class="stats-content text-center">
                <h3 class="stats-number text-info"><?php echo e($stats['read']); ?></h3>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="stats-card enhanced">
            <div class="stats-content text-center">
                <h3 class="stats-number text-success"><?php echo e($stats['replied']); ?></h3>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="stats-card enhanced">
            <div class="stats-content text-center">
                <h3 class="stats-number text-secondary"><?php echo e($stats['closed']); ?></h3>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        <div class="stats-card enhanced">
            <div class="stats-content text-center">
                <h3 class="stats-number text-danger"><?php echo e($stats['high_priority']); ?></h3>
...
<div class="row mb-4">
    <div class="col-12">
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('marketing.contacts')); ?>" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="source" name="source">
                            ...
                            <option value="phone" <?php echo e(request('source') == 'phone' ? 'selected' : ''); ?>>الهاتف</option>
                            <option value="email" <?php echo e(request('source') == 'email' ? 'selected' : ''); ?>>البريد</option>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="contact-row <?php echo e($contact->status === 'new' ? 'table-warning' : ''); ?>">
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            <small class="text-muted"><?php echo e($contact->created_at->format('Y-m-d')); ?></small>
                                            <br>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('marketing.contacts.show', $contact)); ?>" 
                                               class="btn btn-sm btn-outline-primary" title="عرض التفاصيل">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <?php if($contact->status === 'new'): ?>
                                                <form action="<?php echo e(route('marketing.contacts.mark-read', $contact)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php if($contact->status !== 'replied'): ?>
                                                <form action="<?php echo e(route('marketing.contacts.mark-replied', $contact)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                            ...
                                            <?php if($contact->status !== 'closed'): ?>
                                                <form action="<?php echo e(route('marketing.contacts.mark-closed', $contact)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('layouts.marketing-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\marketing\contacts\index.blade.php ENDPATH**/ ?>