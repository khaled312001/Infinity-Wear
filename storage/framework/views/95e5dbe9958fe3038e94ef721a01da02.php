...
<?php $__env->startSection('page-title', 'تعديل الملاحظة'); ?>
<?php $__env->startSection('page-subtitle', 'تعديل ملاحظة العميل'); ?>
            ...
            <div class="dashboard-card">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('admin.customer-notes.show', $customerNote)); ?>" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.customer-notes.update', $customerNote)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($customer->id); ?>" <?php echo e(old('customer_id', $customerNote->customer_id) == $customer->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="marketing" <?php echo e(old('note_type', $customerNote->note_type) == 'marketing' ? 'selected' : ''); ?>>تسويق</option>
                                    <option value="sales" <?php echo e(old('note_type', $customerNote->note_type) == 'sales' ? 'selected' : ''); ?>>مبيعات</option>
                                    <option value="general" <?php echo e(old('note_type', $customerNote->note_type) == 'general' ? 'selected' : ''); ?>>عام</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('title', $customerNote->title)); ?>" placeholder="أدخل عنوان الملاحظة" required>
...
unset($__errorArgs, $__bag); ?>" 
                                          placeholder="أدخل تفاصيل الملاحظة" required><?php echo e(old('content', $customerNote->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="low" <?php echo e(old('priority', $customerNote->priority) == 'low' ? 'selected' : ''); ?>>منخفضة</option>
                                    <option value="medium" <?php echo e(old('priority', $customerNote->priority) == 'medium' ? 'selected' : ''); ?>>متوسطة</option>
                                    <option value="high" <?php echo e(old('priority', $customerNote->priority) == 'high' ? 'selected' : ''); ?>>عالية</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="active" <?php echo e(old('status', $customerNote->status) == 'active' ? 'selected' : ''); ?>>نشطة</option>
                                    <option value="archived" <?php echo e(old('status', $customerNote->status) == 'archived' ? 'selected' : ''); ?>>مؤرشفة</option>
                                    <option value="deleted" <?php echo e(old('status', $customerNote->status) == 'deleted' ? 'selected' : ''); ?>>محذوفة</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('follow_up_date', $customerNote->follow_up_date ? $customerNote->follow_up_date->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('tags', $customerNote->tags ? implode(', ', $customerNote->tags) : '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="<?php echo e(route('admin.customer-notes.show', $customerNote)); ?>" class="btn btn-outline-secondary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\customer-notes\edit.blade.php ENDPATH**/ ?>