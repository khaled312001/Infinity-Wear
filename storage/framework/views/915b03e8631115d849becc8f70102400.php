<?php $__env->startSection('title', 'الفئات - Infinity Wear'); ?>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card category-card h-100">
                        <div class="category-image" 
                             style="background-image: url('<?php echo e($category->image ? asset($category->image) : '/images/placeholder-category.jpg'); ?>')">
                            <div class="category-overlay">
                                <div class="category-info">
                                    <h4 class="category-title"><?php echo e($category->name_ar); ?></h4>
                                    <p class="category-count">فئة متاحة</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e($category->name_ar); ?></h5>
                            <p class="card-text"><?php echo e(Str::limit($category->description_ar, 100)); ?></p>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?php echo e(route('categories.show', $category)); ?>" class="btn btn-primary">
            ...
            <div class="col-md-4">
                <div class="card service-card text-center h-100">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('importers.form')); ?>" class="btn btn-outline-primary">
                            طلب تصميم
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\categories\index.blade.php ENDPATH**/ ?>