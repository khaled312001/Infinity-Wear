...
<?php $__env->startSection('title', 'تحرير التقييم: ' . $testimonial->client_name); ?>
<?php $__env->startSection('dashboard-title', 'لوحة الإدارة'); ?>
<?php $__env->startSection('page-title', 'تحرير التقييم'); ?>
<?php $__env->startSection('page-subtitle', 'تحرير شهادة العميل: ' . $testimonial->client_name); ?>
    ...
    <div class="dashboard-card">
        <div class="card-header bg-white border-bottom">
            <h5 class="mb-0">
                ...
                تحرير التقييم: <?php echo e($testimonial->client_name); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="client_position" name="client_position" value="<?php echo e(old('client_position', $testimonial->client_position)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="client_company" name="client_company" value="<?php echo e(old('client_company', $testimonial->client_company)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php if($testimonial->image): ?>
                                <div class="mt-2">
                                    ...
                                    <img src="<?php echo e(asset('storage/' . $testimonial->image)); ?>" alt="Current image" 
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="1" <?php echo e(old('rating', $testimonial->rating) == '1' ? 'selected' : ''); ?>>⭐ (1)</option>
                                <option value="2" <?php echo e(old('rating', $testimonial->rating) == '2' ? 'selected' : ''); ?>>⭐⭐ (2)</option>
                                <option value="3" <?php echo e(old('rating', $testimonial->rating) == '3' ? 'selected' : ''); ?>>⭐⭐⭐ (3)</option>
                                <option value="4" <?php echo e(old('rating', $testimonial->rating) == '4' ? 'selected' : ''); ?>>⭐⭐⭐⭐ (4)</option>
                                <option value="5" <?php echo e(old('rating', $testimonial->rating) == '5' ? 'selected' : ''); ?>>⭐⭐⭐⭐⭐ (5)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', $testimonial->sort_order)); ?>">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" 
                                       name="is_active" value="1" <?php echo e(old('is_active', $testimonial->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\testimonials\edit.blade.php ENDPATH**/ ?>