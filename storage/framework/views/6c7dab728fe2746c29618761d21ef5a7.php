...
<?php $__env->startSection('page-title', 'المعاملات المالية'); ?>
<?php $__env->startSection('page-subtitle', 'عرض وإدارة جميع المعاملات المالية'); ?>
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="<?php echo e(route('admin.finance.reports')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.finance.dashboard')); ?>">
        ...
        <div class="col-12">
            <div class="dashboard-card">
                ...
                <div class="collapse show" id="filterCollapse">
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('admin.finance.transactions')); ?>" id="filterForm">
                            <div class="row g-3">
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <select name="type" class="form-select">
                                        ...
                                        <option value="income" <?php echo e(request('type') == 'income' ? 'selected' : ''); ?>>إيرادات</option>
                                        <option value="expense" <?php echo e(request('type') == 'expense' ? 'selected' : ''); ?>>مصروفات</option>
                                    </select>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <label class="form-label fw-semibold">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <input type="text" name="search" class="form-control" placeholder="البحث في الوصف..." value="<?php echo e(request('search')); ?>">
                                </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-success text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0"><?php echo e(number_format($transactions->where('type', 'income')->sum('amount'), 2)); ?> ريال</h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-danger text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0"><?php echo e(number_format($transactions->where('type', 'expense')->sum('amount'), 2)); ?> ريال</h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-info text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0"><?php echo e($transactions->where('status', 'completed')->count()); ?></h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-warning text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0"><?php echo e($transactions->where('status', 'pending')->count()); ?></h4>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <span class="badge bg-light text-dark">
                                إجمالي: <?php echo e($transactions->total()); ?> معاملة
                            </span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold"><?php echo e($transaction->transaction_date->format('d/m/Y')); ?></span>
                                                    <small class="text-muted"><?php echo e($transaction->transaction_date->format('H:i')); ?></small>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge bg-<?php echo e($transaction->type === 'income' ? 'success' : 'danger'); ?>">
                                                    <i class="fas fa-arrow-<?php echo e($transaction->type === 'income' ? 'up' : 'down'); ?> me-1"></i>
                                                    <?php echo e($transaction->type === 'income' ? 'إيراد' : 'مصروف'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge bg-light text-dark"><?php echo e($transaction->category); ?></span>
                                            </td>
                                            <td>
                                                <div class="transaction-description">
                                                    <span class="fw-medium"><?php echo e(Str::limit($transaction->description, 50)); ?></span>
                                                    <?php if($transaction->notes): ?>
                                                        <br><small class="text-muted"><?php echo e(Str::limit($transaction->notes, 30)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="fw-bold text-<?php echo e($transaction->type === 'income' ? 'success' : 'danger'); ?>">
                                            ...
                                            <td>
                                                <span class="badge bg-<?php echo e($transaction->status === 'completed' ? 'success' : ($transaction->status === 'pending' ? 'warning' : 'secondary')); ?>">
                                                    <?php echo e($transaction->status === 'completed' ? 'مكتملة' : ($transaction->status === 'pending' ? 'معلقة' : 'ملغية')); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if($transaction->payment_method): ?>
                                                    <span class="badge bg-info"><?php echo e($transaction->payment_method); ?></span>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo e(route('admin.finance.show', $transaction)); ?>" 
                                                       class="btn btn-sm btn-outline-primary" title="عرض">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('admin.finance.edit', $transaction)); ?>" 
                                                       class="btn btn-sm btn-outline-warning" title="تعديل">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-outline-danger delete-transaction-btn" 
                                                            data-transaction-id="<?php echo e($transaction->id); ?>" title="حذف">
                        ...
                        <div class="card-footer bg-white border-top">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="text-muted">
                                    عرض <?php echo e($transactions->firstItem()); ?> إلى <?php echo e($transactions->lastItem()); ?> من <?php echo e($transactions->total()); ?> معاملة
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\finance\transactions.blade.php ENDPATH**/ ?>