...
<?php $__env->startSection('title', 'إضافة جهة اتصال جديدة'); ?>
<?php $__env->startSection('dashboard-title', 'إضافة جهة اتصال جديدة'); ?>
<?php $__env->startSection('page-title', 'إضافة جهة اتصال جديدة'); ?>
<?php $__env->startSection('page-subtitle', 'إضافة جهة اتصال مخصصة للفريقين'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="message" name="message" rows="4" required><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="inquiry" <?php echo e(old('contact_type') == 'inquiry' ? 'selected' : ''); ?>>استفسار</option>
                                    <option value="custom" <?php echo e(old('contact_type') == 'custom' ? 'selected' : ''); ?>>مخصص</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="marketing" <?php echo e(old('assigned_to') == 'marketing' ? 'selected' : ''); ?>>فريق التسويق</option>
                                    <option value="sales" <?php echo e(old('assigned_to') == 'sales' ? 'selected' : ''); ?>>فريق المبيعات</option>
                                    <option value="both" <?php echo e(old('assigned_to') == 'both' ? 'selected' : ''); ?>>كلا الفريقين</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="phone" <?php echo e(old('source') == 'phone' ? 'selected' : ''); ?>>الهاتف</option>
                                    <option value="email" <?php echo e(old('source') == 'email' ? 'selected' : ''); ?>>البريد الإلكتروني</option>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\infinity\Infinity-Wear\resources\views\admin\contacts\create.blade.php ENDPATH**/ ?>