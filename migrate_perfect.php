<?php
/**
 * Perfect Database Migration Script: SQLite to MySQL
 * This script handles all default values correctly and migrates all data
 */
...
echo "=== Perfect Database Migration: SQLite to MySQL ===\n";
...
try {
    ...
    // Create database
    echo "3. Creating MySQL database...\n";
        ...
        try {
            ...
            if (count($data) > 0) {
                ...
                foreach ($columns as $column) {
                    ...
                    // Handle default values properly - remove problematic defaults
                    if ($defaultValue !== null && $name !== 'id') {
                        if ($defaultValue === 'CURRENT_TIMESTAMP') {
                            $columnDef .= ' DEFAULT CURRENT_TIMESTAMP';
                        } elseif (is_numeric($defaultValue) && $defaultValue != '') {
                            $columnDef .= " DEFAULT $defaultValue";
                        } elseif ($defaultValue === '1' || $defaultValue === 1) {
                            $columnDef .= " DEFAULT 1";
                            ...
                            $columnDef .= " DEFAULT 0";
                        } elseif ($defaultValue !== '' && $defaultValue !== null) {
                ...
                $mysql->exec($createSQL);
                echo "   ✓ Empty table structure created\n";
            }
