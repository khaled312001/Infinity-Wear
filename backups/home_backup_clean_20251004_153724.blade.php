...
@section('content')
    ...
    <!-- Contact Section -->
    <section id="contact" class="contact-section-main">
        <div class="container">
            <div class="section-header">
            ...
            <div class="contact-info-section">
                ...
                <div class="contact-cards-grid">
                    <div class="contact-card-item" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="contact-map-section" data-aos="fade-right" data-aos-delay="500">
                    ...
                    <div class="map-container">
                        ...
                        <iframe 
                            ...
                            width="100%" 
                            height="400" 
                            style="border:0; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); display: block;" 
                            allowfullscreen="" 
                            loading="lazy" 
...
@section('scripts')
    ...
    <script src="{{ asset('js/football-minimal.js') }}"></script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (googleMap) {
                ...
                // Fallback timer - if Google Maps doesn't load within 3 seconds, show OpenStreetMap
                setTimeout(function() {
                    if (googleMap.offsetHeight === 0 || !googleMap.contentDocument) {
