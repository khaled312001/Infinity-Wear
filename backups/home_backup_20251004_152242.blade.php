...
@section('content')
    ...
    <section id="portfolio" class="infinity-portfolio">
        <div class="container">
            ...
            <div class="infinity-portfolio-filters">
                <button class="filter-btn active" data-filter="all">جميع الأعمال</button>
                <button class="filter-btn" data-filter="football">كرة قدم</button>
                <button class="filter-btn" data-filter="basketball">كرة سلة</button>
                <button class="filter-btn" data-filter="schools">مدارس</button>
                <button class="filter-btn" data-filter="companies">شركات</button>
            </div>

            <div class="infinity-portfolio-grid">
                <div class="portfolio-item" data-category="football">
                    <div class="portfolio-image">
                        <img src="{{ asset('images/portfolio/football_kit_1.jpg') }}" alt="فريق كرة قدم الرياض">
                        <div class="portfolio-overlay">
                            <div class="portfolio-content">
                                <h3>فريق كرة قدم الرياض</h3>
                                <p>زي كامل لفريق كرة قدم محلي</p>
                ...
                <div class="portfolio-item" data-category="schools">
                    <div class="portfolio-image">
                        <img src="{{ asset('images/portfolio/school_uniform_1.jpg') }}" alt="جامعة الملك سعود">
                        <div class="portfolio-overlay">
                            <div class="portfolio-content">
    ...
    <section id="contact" class="infinity-contact">
        <div class="container">
            ...
            <div class="infinity-contact-content">
                ...
                <div class="infinity-contact-form-container" data-aos="fade-left" data-aos-delay="500">
            ...
            <!-- خريطة تفاعلية -->
            <div class="contact-map-section" data-aos="fade-up" data-aos-delay="600">
