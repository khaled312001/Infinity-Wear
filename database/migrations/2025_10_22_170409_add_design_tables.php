...
return new class extends Migration
{
    public function up()
    {
        ...
        if (!Schema::hasTable('design_3d_data')) {
        ...
        if (!Schema::hasTable('design_files')) {
        ...
        if (!Schema::hasTable('design_metadata')) {
        ...
        if (!Schema::hasTable('design_progress')) {
        ...
        if (!Schema::hasTable('design_communications')) {
