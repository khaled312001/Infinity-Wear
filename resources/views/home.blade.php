            ...
            <div class="infinity-contact-content">
                <div class="infinity-contact-info" style="width: 100%; margin-bottom: 2rem;">
                    ...
                    <div class="infinity-contact-card">
                        ...
                        <div class="infinity-contact-details">
                            <h3>واتساب</h3>
                            <p><a href="https://wa.me/{{ str_replace(['+', ' ', '-'], '', \App\Models\Setting::get('whatsapp_number')) }}" target="_blank">{{ \App\Models\Setting::get('whatsapp_number') }}</a></p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="infinity-contact-card">
                        ...
                        <div class="infinity-contact-details">
                            <h3>رقم الطوارئ</h3>
                            <p><a href="tel:{{ \App\Models\Setting::get('emergency_contact') }}">{{ \App\Models\Setting::get('emergency_contact') }}</a></p>
                        </div>
                    </div>
                    @endif
                        ...
                        <div class="infinity-contact-details">
                            ...
                            <div class="social-links">
                                @if(\App\Models\Setting::get('facebook_url'))
                                    <a href="{{ \App\Models\Setting::get('facebook_url') }}" target="_blank" class="social-link facebook">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                @endif
                                @if(\App\Models\Setting::get('twitter_url'))
                                    <a href="{{ \App\Models\Setting::get('twitter_url') }}" target="_blank" class="social-link twitter">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                @endif
                                @if(\App\Models\Setting::get('instagram_url'))
                                    <a href="{{ \App\Models\Setting::get('instagram_url') }}" target="_blank" class="social-link instagram">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                @endif
                                @if(\App\Models\Setting::get('linkedin_url'))
                                    <a href="{{ \App\Models\Setting::get('linkedin_url') }}" target="_blank" class="social-link linkedin">
                                        <i class="fab fa-linkedin-in"></i>
                                    </a>
                                @endif
                                @if(\App\Models\Setting::get('youtube_url'))
                                    <a href="{{ \App\Models\Setting::get('youtube_url') }}" target="_blank" class="social-link youtube">
                                        <i class="fab fa-youtube"></i>
                                    </a>
                                @endif
                                @if(\App\Models\Setting::get('tiktok_url'))
                                    <a href="{{ \App\Models\Setting::get('tiktok_url') }}" target="_blank" class="social-link tiktok">
