...
@section('description', 'تعرف على مؤسسة الزي اللامحدود - شركة سعودية رائدة في تصميم وإنتاج الملابس الرياضية والزي الموحد للفرق والمدارس والشركات')
...
.about-team-image {
    height: 200px;
    background-image: url('{{ asset('images/sections/team-collaboration.svg') }}');
