    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top shadow-sm">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <a class="navbar-brand d-flex align-items-center" href="{{ route('sales.dashboard') }}">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="{{ route('sales.profile') }}"><i class="fas fa-user me-2"></i>الملف الشخصي</a></li>
                ...
                <div class="main-content">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="page-subtitle">@yield('page-subtitle', 'مرحبا بك في لوحة تحكم المبيعات')</p>
                        </div>
                        <div>
                            @yield('page-actions')
                        </div>
