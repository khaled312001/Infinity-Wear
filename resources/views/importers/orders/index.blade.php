...
@section('title', 'طلبات الاستيراد')
@section('dashboard-title', 'لوحة المستورد')
@section('page-title', 'طلبات الاستيراد')
@section('page-subtitle', 'إدارة وتتبع جميع طلبات الاستيراد')
...
@section('sidebar-menu')
    ...
    <a href="{{ route('importers.orders') }}" class="nav-link active">
                                ...
                                <tr data-status="{{ $order->status }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>{{ $order->product_type ?? 'منتج عام' }}</strong>
                                                <br>
                                                <small class="text-muted">{{ $order->category ?? 'غير محدد' }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <strong>{{ number_format($order->estimated_cost ?? 0, 2) }} ر.س</strong>
                                    </td>
                                    <td>
                                        @switch($order->status)
                                            @case('pending')
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">تفاصيل طلب الاستيراد #{{ $order->id }}</h5>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <table class="table table-sm">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><strong>{{ number_format($order->estimated_cost ?? 0, 2) }} ر.س</strong></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <table class="table table-sm">
                                                            <tr>
                                                                ...
                                                                <td>{{ $order->product_type ?? 'منتج عام' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong>الفئة:</strong></td>
                                                                <td>{{ $order->category ?? 'غير محدد' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong>المواصفات:</strong></td>
                                                                <td>{{ $order->specifications ?? 'غير محدد' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td><strong>البلد المصدر:</strong></td>
                                                                <td>{{ $order->source_country ?? 'غير محدد' }}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stats-card">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-0">{{ $orders->where('status', 'in_progress')->count() }}</h3>
