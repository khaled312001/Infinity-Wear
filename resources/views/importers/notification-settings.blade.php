...
@section('title', 'إعدادات الإشعارات - لوحة تحكم المستورد')
@section('dashboard-title', 'لوحة المستورد')
@section('page-title', 'إعدادات الإشعارات')
@section('page-subtitle', 'تخصيص تفضيلات الإشعارات')
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('importers.notification-settings.update') }}">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="shipping_updates" 
                                               ...
                                               {{ $settings['shipping_updates'] ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="invoice_notifications" 
                                               ...
                                               {{ $settings['invoice_notifications'] ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="system_announcements" 
                                               ...
                                               {{ $settings['system_announcements'] ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="marketing_emails" 
                                               ...
                                               {{ $settings['marketing_emails'] ? 'checked' : '' }}>
            ...
            <div class="dashboard-card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <strong>{{ $importer->email }}</strong>
                    </div>
                    
                    <div class="mb-3">
                        <h6 class="text-primary">الرسائل النصية</h6>
                        <p class="text-muted mb-2">الإشعارات المرسلة إلى:</p>
                        <strong>{{ $importer->phone }}</strong>
                    </div>
                    
                    <div class="mb-3">
                        <h6 class="text-primary">آخر تحديث</h6>
                        <p class="text-muted mb-0">{{ now()->format('Y-m-d H:i') }}</p>
                    </div>
                </div>
            </div>
...
function testEmailNotification() {
    alert('تم إرسال إشعار تجريبي إلى البريد الإلكتروني: {{ $importer->email }}');
    // يمكن إضافة AJAX call لإرسال إشعار تجريبي
}

function testSMSNotification() {
    alert('تم إرسال إشعار تجريبي إلى رقم الهاتف: {{ $importer->phone }}');
    // يمكن إضافة AJAX call لإرسال إشعار تجريبي
}
