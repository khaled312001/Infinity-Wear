    ...
    <div class="container">
        ...
        <div class="order-info">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $order->order_number ?? 'غير محدد' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">تاريخ الطلب:</span>
                <span class="info-value">{{ $order->created_at ? $order->created_at->format('Y-m-d H:i') : 'غير محدد' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">المبلغ الإجمالي:</span>
                <span class="info-value">{{ $order->total ?? 'غير محدد' }} ريال</span>
            </div>
            <div class="info-row">
                <span class="info-label">حالة الطلب:</span>
                <span class="info-value">{{ $order->status ?? 'جديد' }}</span>
            </div>
        </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ url('/admin/orders/' . ($order->id ?? '')) }}" class="btn">عرض تفاصيل الطلب</a>
            <a href="{{ url('/admin/orders') }}" class="btn">جميع الطلبات</a>
        </div>
