...
@section('page-title', 'إضافة معاملة مالية')
@section('page-subtitle', 'إضافة إيراد أو مصروف جديد')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.finance.store') }}" method="POST" id="transactionForm">
                        @csrf
