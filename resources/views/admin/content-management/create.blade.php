...
@section('page-subtitle', 'إنشاء محتوى جديد للموقع')
...
<div class="row">
    <div class="col-12">
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.content-management.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('page_name') is-invalid @enderror" id="page_name" name="page_name" required>
                                            ...
                                            @foreach($pages as $key => $value)
                                                <option value="{{ $key }}" {{ old('page_name') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('page_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('section_name') is-invalid @enderror" id="section_name" name="section_name" required>
                                            ...
                                            @foreach($sections as $key => $value)
                                                <option value="{{ $key }}" {{ old('section_name') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('section_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('content_type') is-invalid @enderror" id="content_type" name="content_type" required>
                                            ...
                                            @foreach($contentTypes as $key => $value)
                                                <option value="{{ $key }}" {{ old('content_type') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('content_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('content_ar') is-invalid @enderror" 
                                                  id="content_ar" name="content_ar" rows="4">{{ old('content_ar') }}</textarea>
                                        @error('content_ar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
