...
@section('title', 'تحرير التقييم: ' . $testimonial->client_name)
@section('dashboard-title', 'لوحة الإدارة')
@section('page-title', 'تحرير التقييم')
@section('page-subtitle', 'تحرير شهادة العميل: ' . $testimonial->client_name)
    ...
    <div class="dashboard-card">
        <div class="card-header bg-white border-bottom">
            <h5 class="mb-0">
                ...
                تحرير التقييم: {{ $testimonial->client_name }}
            </h5>
        </div>
        <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('client_position') is-invalid @enderror" 
                                           id="client_position" name="client_position" value="{{ old('client_position', $testimonial->client_position) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('client_company') is-invalid @enderror" 
                                           id="client_company" name="client_company" value="{{ old('client_company', $testimonial->client_company) }}" required>
