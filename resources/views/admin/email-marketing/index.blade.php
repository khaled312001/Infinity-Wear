...
@section('title', 'التسويق بالبريد الإلكتروني')
@section('dashboard-title', 'لوحة الإدارة')
@section('page-title', 'التسويق بالبريد الإلكتروني')
@section('page-subtitle', 'إرسال رسائل تسويقية للعملاء والفرق')
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card stats-card position-relative">
            <div class="card-body">
                ...
                <div class="stats-number" id="totalUsers">{{ $userCounts['all'] }}</div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card stats-card position-relative" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
            <div class="card-body">
                ...
                <div class="stats-number" id="customerCount">{{ $userCounts['customers'] }}</div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card stats-card position-relative" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
            <div class="card-body">
                ...
                <div class="stats-number" id="importerCount">{{ $userCounts['importers'] }}</div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card stats-card position-relative" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
            <div class="card-body">
                ...
                <div class="stats-number" id="teamCount">{{ $userCounts['sales'] + $userCounts['marketing'] }}</div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="{{ route('admin.email-marketing.create') }}" class="quick-action-btn primary d-block">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="{{ route('admin.email-marketing.create') }}?type=customers" class="quick-action-btn success d-block">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="{{ route('admin.email-marketing.create') }}?type=importers" class="quick-action-btn warning d-block">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="{{ route('admin.email-marketing.create') }}?type=teams" class="quick-action-btn info d-block">
