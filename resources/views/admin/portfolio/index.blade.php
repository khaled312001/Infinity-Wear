...
@section('page-subtitle', 'إدارة وتنظيم أعمال المعرض')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('portfolio.index') }}" class="btn btn-outline-primary" target="_blank">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-primary text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0">{{ $portfolioItems->total() }}</h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-warning text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0">{{ $portfolioItems->where('is_featured', true)->count() }}</h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-success text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0">{{ $portfolioItems->where('is_active', true)->count() }}</h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card bg-gradient-info text-white">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0">{{ $portfolioItems->pluck('category')->unique()->count() }}</h4>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <span class="badge bg-light text-dark">
                        إجمالي: {{ $portfolioItems->total() }} عمل
                    </span>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="portfolio-row">
                                ...
                                <td>
                                    <span class="badge bg-{{ $item->category === 'football' ? 'success' : ($item->category === 'basketball' ? 'primary' : ($item->category === 'schools' ? 'info' : ($item->category === 'companies' ? 'warning' : ($item->category === 'medical' ? 'danger' : 'secondary')))) }}">
                                        {{ $item->category }}
                                    </span>
                                </td>
                                <td>
                                    <div class="client-info">
                                        <span class="fw-medium">{{ $item->client_name ?? 'غير محدد' }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="date-info">
                                        <span class="fw-medium">{{ $item->completion_date ? $item->completion_date->format('d/m/Y') : 'غير محدد' }}</span>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge {{ $item->is_featured ? 'bg-warning text-dark' : 'bg-secondary' }}">
                                        <i class="fas fa-{{ $item->is_featured ? 'star' : 'circle' }} me-1"></i>
                                ...
                                <td>
                                    <span class="badge {{ $item->is_active ? 'bg-success' : 'bg-secondary' }}">
                                        <i class="fas fa-{{ $item->is_active ? 'check-circle' : 'times-circle' }} me-1"></i>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger delete-portfolio-btn" 
                                                ...
                                                data-portfolio-title="{{ $item->title }}" title="حذف">
                ...
                <div class="card-footer bg-white border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            عرض {{ $portfolioItems->firstItem() }} إلى {{ $portfolioItems->lastItem() }} من {{ $portfolioItems->total() }} عمل
                        </div>
                        <div>
