...
@section('page-title', 'اختبار الواتساب')
@section('page-subtitle', 'اختبار إرسال واستقبال الرسائل عبر الواتساب')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                <li><strong>الرقم الأساسي:</strong> {{ config('whatsapp.primary_number', 'غير محدد') }}</li>
                                <li><strong>API مفعل:</strong> 
                                    @if(config('whatsapp.api.enabled', false))
                                ...
                                <li><strong>مزود الخدمة:</strong> 
                                    @if(config('whatsapp.api.provider', 'auto_api') === 'auto_api')
                                        <span class="badge bg-success">Auto API (إرسال تلقائي)</span>
                                    @else
                                        <span class="badge bg-info">{{ config('whatsapp.api.provider', 'auto_api') }}</span>
                                    @endif
                                </li>
                                <li><strong>API Token:</strong> 
                                    @if(config('whatsapp.api.api_token'))
                                ...
                                <li><strong>WhatsApp Web:</strong> 
                                    @if(config('whatsapp.web.enabled', true))
                                        <span class="badge bg-success">مفعل</span>
                                    @else
                                        <span class="badge bg-danger">معطل</span>
                                    @endif
