...
@section('title', 'إعدادات المشرف - لوحة التحكم')
@section('dashboard-title', 'إعدادات المشرف')
@section('page-title', 'إعدادات المشرف')
@section('page-subtitle', 'إدارة إعداداتك الشخصية وتفضيلات النظام')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="language" name="language" required>
                                <option value="ar" {{ $admin->language == 'ar' ? 'selected' : '' }}>العربية</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="timezone" name="timezone" required>
                                <option value="Asia/Riyadh" {{ $admin->timezone == 'Asia/Riyadh' ? 'selected' : '' }}>الرياض (GMT+3)</option>
                                <option value="Asia/Dubai" {{ $admin->timezone == 'Asia/Dubai' ? 'selected' : '' }}>دبي (GMT+4)</option>
                                <option value="Europe/London" {{ $admin->timezone == 'Europe/London' ? 'selected' : '' }}>لندن (GMT+0)</option>
                                <option value="America/New_York" {{ $admin->timezone == 'America/New_York' ? 'selected' : '' }}>نيويورك (GMT-5)</option>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="email_notifications" 
                                           ...
                                           {{ json_decode($admin->notification_settings ?? '{}', true)['email'] ?? false ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="sms_notifications" 
                                           ...
                                           {{ json_decode($admin->notification_settings ?? '{}', true)['sms'] ?? false ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="push_notifications" 
                                           ...
                                           {{ json_decode($admin->notification_settings ?? '{}', true)['push'] ?? false ? 'checked' : '' }}>
