...
@section('page-subtitle', 'إدارة محتوى الموقع وإعدادات الـ SEO')
...
@section('page-actions')
    <div class="d-flex gap-2">
        <a href="{{ route('admin.content.seo') }}" class="btn btn-outline-primary">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0">{{ $stats['pages_count'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0">{{ $stats['seo_status'] ?? 0 }}%</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0">{{ $stats['cache_size'] ?? '0 KB' }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0 small">{{ $stats['last_update'] ?? 'غير محدد' }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('admin.content.seo') }}" class="btn btn-primary">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('admin.content-management.index') }}" class="btn btn-info">
                                        <i class="fas fa-arrow-left me-2"></i>
                                        إدارة المحتوى
                                    </a>
                                </div>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="{{ route('admin.content.seo') }}" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('admin.content-management.index') }}" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-center">
            ...
            <div class="card shadow-sm border-0 mt-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span>حالة SEO</span>
                        <span class="badge bg-{{ $stats['seo_status'] >= 80 ? 'success' : ($stats['seo_status'] >= 50 ? 'warning' : 'danger') }}">
                            {{ $stats['seo_status'] ?? 0 }}%
                        </span>
                    </div>
                    <div class="progress mb-3" style="height: 6px;">
                        <div class="progress-bar bg-{{ $stats['seo_status'] >= 80 ? 'success' : ($stats['seo_status'] >= 50 ? 'warning' : 'danger') }}" 
                             style="width: {{ $stats['seo_status'] ?? 0 }}%"></div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span>حجم الكاش</span>
                        <span class="text-muted">{{ $stats['cache_size'] ?? '0 KB' }}</span>
                    </div>

                    <div class="d-flex justify-content-between align-items-center">
                        <span>آخر تحديث</span>
                        <span class="text-muted small">{{ $stats['last_update'] ?? 'غير محدد' }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function generateSitemap() {
            if (confirm('هل تريد إنشاء خريطة الموقع؟ سيتم إنشاء ملف sitemap.xml في المجلد الرئيسي للموقع.')) {
                ...
                fetch('{{ route("admin.content.generate-sitemap") }}', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                        'Content-Type': 'application/json',
