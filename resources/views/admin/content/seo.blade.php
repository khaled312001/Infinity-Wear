...
<div class="container-fluid py-4">
    ...
    <!-- نموذج إعدادات SEO -->
    <form action="{{ route('admin.content.seo.update') }}" method="POST">
        @csrf
        <div class="row">
            <!-- الإعدادات العامة -->
            <div class="col-lg-8">
                <div class="seo-card">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="site_description" rows="3" 
                                  maxlength="160" 
                                  onkeyup="updateCharCount(this, 'desc-count', 160); updatePreview()">{{ $seoData['site_description'] ?? '' }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="site_keywords" rows="2" 
                                  placeholder="ملابس رياضية، زي موحد، أكاديميات رياضية، السعودية">{{ $seoData['site_keywords'] ?? '' }}</textarea>
