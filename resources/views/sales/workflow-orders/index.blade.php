    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="dashboard-card mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('sales.workflow-orders.index') }}" class="row g-3">
                        <div class="col-md-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $color = $statusColors[$order->sales_status] ?? 'secondary';
                                                $labels = [
                                                    'pending' => 'في الانتظار',
                                                ...
                                                $label = $labels[$order->sales_status] ?? $order->sales_status;
                                            @endphp
                                        ...
                                        <td>
                                            <a href="{{ route('sales.workflow-orders.show', $order) }}" class="btn btn-sm btn-outline-primary">
