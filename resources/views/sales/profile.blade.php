...
@section('title', 'الملف الشخصي - فريق المبيعات')
            ...
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-6 mb-3">
                        <h4 class="text-primary mb-1">{{ \App\Models\Order::count() }}</h4>
                        <small class="text-muted">الطلبات</small>
                    </div>
                    <div class="col-6 mb-3">
                        <h4 class="text-success mb-1">{{ \App\Models\ImporterOrder::count() }}</h4>
                        <small class="text-muted">طلبات المستوردين</small>
                    </div>
                    <div class="col-6">
                        <h4 class="text-warning mb-1">{{ \App\Models\Task::where('department', 'sales')->count() }}</h4>
                        <small class="text-muted">المهام</small>
                    </div>
                    <div class="col-6">
                        <h4 class="text-info mb-1">{{ \App\Models\Importer::count() }}</h4>
