...
@section('title', 'تعديل تقرير المندوب التسويقي')
@section('dashboard-title', 'تعديل تقرير المندوب التسويقي')
@section('page-title', 'تعديل تقرير المندوب التسويقي')
@section('page-subtitle', 'تعديل تقرير المندوب التسويقي')
...
<div class="row">
    <div class="col-12">
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <form action="{{ route('sales.marketing-reports.update', $marketingReport) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="representative_name" class="form-select @error('representative_name') is-invalid @enderror" required>
                                ...
                                <option value="عمرو الدسوقي" {{ old('representative_name', $marketingReport->representative_name) == 'عمرو الدسوقي' ? 'selected' : '' }}>عمرو الدسوقي</option>
                                <option value="محمد علي" {{ old('representative_name', $marketingReport->representative_name) == 'محمد علي' ? 'selected' : '' }}>محمد علي</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" 
                                   value="{{ old('company_name', $marketingReport->company_name) }}" required>
                            @error('company_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="company_address" class="form-control @error('company_address') is-invalid @enderror" 
                                      rows="3" required>{{ old('company_address', $marketingReport->company_address) }}</textarea>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="responsible_name" class="form-control @error('responsible_name') is-invalid @enderror" 
                                   value="{{ old('responsible_name', $marketingReport->responsible_name) }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" name="responsible_phone" class="form-control @error('responsible_phone') is-invalid @enderror" 
                                   value="{{ old('responsible_phone', $marketingReport->responsible_phone) }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="responsible_position" class="form-control @error('responsible_position') is-invalid @enderror" 
                                   value="{{ old('responsible_position', $marketingReport->responsible_position) }}" required>
                        ...
                        <div class="col-12 mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="الخامة" 
                                               {{ in_array('الخامة', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="الجودة" 
                                               {{ in_array('الجودة', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="وقت التسليم" 
                                               {{ in_array('وقت التسليم', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="customer_concerns[]" value="السعر" 
                                               {{ in_array('السعر', old('customer_concerns', $marketingReport->customer_concerns ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="mt-2">
                                <input type="text" name="customer_concerns[]" class="form-control" placeholder="أخرى:" 
                                       value="{{ old('customer_concerns.4', $marketingReport->customer_concerns[4] ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="target_quantity" class="form-control @error('target_quantity') is-invalid @enderror" 
                                   value="{{ old('target_quantity', $marketingReport->target_quantity) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="annual_consumption" class="form-control @error('annual_consumption') is-invalid @enderror" 
                                   value="{{ old('annual_consumption', $marketingReport->annual_consumption) }}" required>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="recommendations" class="form-control @error('recommendations') is-invalid @enderror" 
                                      rows="4">{{ old('recommendations', $marketingReport->recommendations) }}</textarea>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="next_steps" class="form-control @error('next_steps') is-invalid @enderror" 
                                      rows="4">{{ old('next_steps', $marketingReport->next_steps) }}</textarea>
                            @error('next_steps')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" 
                                      rows="3">{{ old('notes', $marketingReport->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('sales.marketing-reports.show', $marketingReport) }}" class="btn btn-secondary">
