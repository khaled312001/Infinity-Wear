                            ...
                            <div class="task-column" data-column-id="{{ $column->id }}" data-board-id="{{ $board->id }}">
                                ...
                                <div class="column-content" id="column-{{ $column->id }}-tasks">
                                    @foreach($column->tasks as $task)
                                        <div class="task-card {{ $task->assigned_to == auth()->user()->id && $task->assigned_to_type == 'sales' ? 'draggable-task' : 'non-draggable-task' }}" 
                                             data-task-id="{{ $task->id }}" 
                                             data-assigned-to="{{ $task->assigned_to }}" 
                                             data-assigned-to-type="{{ $task->assigned_to_type }}" 
                                             draggable="{{ $task->assigned_to == auth()->user()->id && $task->assigned_to_type == 'sales' ? 'true' : 'false' }}">
                                            ...
                                            <div class="task-footer">
                                                ...
                                                <div class="task-actions">
                                                    ...
                                                    @if($task->assigned_to == auth()->user()->id && $task->assigned_to_type == 'sales')
