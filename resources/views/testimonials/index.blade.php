...
@section('title', 'آراء العملاء - مؤسسة الزي اللامحدود')

@section('styles')
<link href="{{ asset('css/enhanced-pages.css') }}" rel="stylesheet">
<style>
                    ...
                    <div class="testimonial-header">
                        <div class="testimonial-avatar">
                            @if($testimonial->image)
                                <img src="{{ asset('storage/' . $testimonial->image) }}" alt="{{ $testimonial->client_name }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                            @else
